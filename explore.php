...
<div id="content">
    ...
    if ($connection->connect_errno) {
        ...
        $sql = "SELECT * FROM cook_recipes WHERE checked=1 ORDER BY ".$order;
        $prep = $connection->prepare($sql);
        $prep->execute();
        $result = $prep->get_result();

        if ($result->num_rows>0) {
            echo '<table id="recipes" cellpadding="5px" cellspacing="0px" border="1px"><th><a href="explore.php?order=name"> Nazwa dania </a></th><th><a href="explore.php?order=time"> Czas przgotowania </a></th><th><a href="explore.php?order=author">Autor</a></th><th><a href="explore.php?order=date">Data dodania</a></th>';
